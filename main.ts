...
$(document).ready(function () {
    ...
    $("#slider2").click(function(){
        ...
        $("#slider-text-1").text("MAKE YOUR VACATION COMFORTABLE");
        $("#slider-text").text("deluxe hotel");
    ...
    $("#slider3").click(function(){
        ...
        $("#slider-text-1").text("A BEST PLACE TO ENJOY YOUR LIFE");
        $("#slider-text").text("LUXE HOTEL");
